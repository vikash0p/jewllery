...
const DiscountMiddlePage = () => {
  ...
  return (
    <div className="discountMiddlePageBackgroundImage w-full h-80 md:h-96 lg:h-[550px] mt-10 ">
      <div className="container grid h-full grid-cols-1 m-auto md:grid-cols-2">
        <div className=""></div>
        <div className="flex flex-col items-start justify-center gap-3  md:gap-4 lg:gap-6  ">
